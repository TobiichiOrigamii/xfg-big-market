/*
 ...
 Source Schema         : xfg_frame_archetype

 Target Server Type    : MySQL
 Target Server Version : 80032 (8.0.32)
 File Encoding         : 65001

 Date: 26/09/2024 14:19:25
*/
...
CREATE TABLE `employee`  (
  ...
  `employee_number` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '雇员ID',
  `employee_name` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '雇员姓名',
  `employee_level` varchar(8) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '雇员级别',
  `employee_title` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '雇员岗位Title',
...
CREATE TABLE `employee_salary`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `employee_number` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '雇员编号',
...
CREATE TABLE `employee_salary_adjust`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `employee_number` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '雇员编号',
  `adjust_order_id` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '调薪单号',
  ...
  `update_time` datetime NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_order_id`(`adjust_order_id` ASC) USING BTREE
