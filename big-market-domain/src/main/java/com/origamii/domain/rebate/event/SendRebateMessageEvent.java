package com.origamii.domain.rebate.event;
...
public class SendRebateMessageEvent extends BaseEvent<SendRebateMessageEvent.RebateMessage> {
    ...
    @Override
    public EventMessage<SendRebateMessageEvent.RebateMessage> buildEventMessage(SendRebateMessageEvent.RebateMessage data) {
